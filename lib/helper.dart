...
class Helper {
  ...
  List<Perguntas> _bancoDePerguntas = [
    ...
    Perguntas('Qual é o elemento químico mais abundante no universo?',
        'Hidrogênio', ['Oxigênio', 'Ferro', 'Hélio', 'Carbono', 'Hidrogênio']),
    ...
    Perguntas('Qual é o animal terrestre mais rápido do mundo?', 'Guepardo',
        ['Leão', 'Elefante', 'Tigre', 'Guepardo', 'Lobo']),
    ...
    Perguntas('Qual é o nome da constelação mais próxima da Terra?',
        'Alpha Centauri',
        ['Andrômeda', 'Orion', 'Pégaso', 'Alpha Centauri', 'Centauro']),
    ...
    Perguntas('Qual é o metal líquido à temperatura ambiente?', 'Mercúrio',
        ['Ferro', 'Chumbo', 'Alumínio', 'Mercúrio', 'Ouro']),
    Perguntas('Qual é o único planeta do sistema solar que gira de leste a oeste?',
        'Vênus',
        ['Mercúrio', 'Vênus', 'Marte', 'Júpiter', 'Urano']),
    Perguntas('Quem foi o primeiro imperador romano?', 'César Augusto',
        ['César Augusto', 'Nero', 'Calígula', 'Júlio César', 'Trajano']),
    Perguntas('Qual é o processo pelo qual as plantas produzem alimentos?',
        'Fotossíntese',
        ['Respiração', 'Fotossíntese', 'Digestão', 'Transpiração', 'Absorção']),
